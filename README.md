...
- 🤖 **Discord-AutoMsg**: A Discord bot that sends automated messages with embedded content at specific times, developed using `nextcord` and `dotenv` to load environment variables and handle bot functionality.
